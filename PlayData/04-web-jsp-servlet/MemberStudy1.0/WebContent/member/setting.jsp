...
<%
	// 프로젝트 경로
	String project = "/MemberStudy1.0/member/";
	...
	String page_zipcheck = "우편 번호 검색";
	String page_emailconfirm = "이메일 인증";
	...
	String btn_auth = "메일인증";
	
	String btn_del = "탈퇴";
	String btn_del_cancel = "탈퇴취소";
	String btn_search = "검색	";
	...
	String str_msg_address = "읍,면,동 단위로 검색해주세요";
	String str_msg_emailconfirm = "인증번호를 입력하세요";
%>