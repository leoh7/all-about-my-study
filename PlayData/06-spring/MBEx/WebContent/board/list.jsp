...
%>
<jsp:include page="../member/main.jsp" flush="false"/>
<div class="container">
	...
	<tr>
		<th colspan="6" align="right">
			<div class="d-flex justify-content-end">
				<a class = text-info href="boardWriteForm.do">${str_write}</a>
			</div>
		</th>
	</tr>
		<tr>
		...
		<c:forEach var="article" items="${articles}">
			<tr>
				...
				<td>
					...
					<a class = text-info href="boardContent.do?num=${article.getNum()}&pageNum=${pageNum}&list_num=${number+1}">
						${article.getSubject()}
					</a>
				</td>
...
<c:if test="${count gt 0}">
	<ul class="pagination pagination-sm">
		<c:if test="${startPage gt pageBlock}">
			<li class="page-item"><a class = "page-link" href="boardList.do">◀◀</a></li>
			<li class="page-item"><a class = "page-link" href="boardList.do?pageNum=${startPage-pageBlock}">◀</a></li>
		</c:if>
		...
		<c:forEach var="i" begin="${startPage}" end="${endPage}">
			...
			<c:if test="${i ne currentPage}">
				<li class="page-item"><a class = "page-link" href="boardList.do?pageNum=${i}">${i}</a></li>
			</c:if>
		</c:forEach>
		
		<c:if test="${pageCount gt endPage}">
			<li class="page-item"><a class = "page-link" href="boardList.do?pageNum=${startPage+pageBlock}">▶</a></li>
			<li class="page-item"><a class = "page-link" href="boardList.do?pageNum=${pageCount}">▶▶</a></li>
		</c:if>
	</ul>
</c:if>
